...
//arrays for testing
//a1
export const words_g2_tests_a1 = ["зоопарк", "кухня", "сторінка", "радіо", "музей", "ванна", "насолоджуватися", "танці",
    "товстий", "скло", "пам'ятати", "стілець", "близько", "велосипед", "ручка", "газета", "містечко", "хотіти", "теніс", "дивитися"
];
...
export const answers_g2_tests_a1 = [["зоопарк","сторінка","лист","ветеринар"],
    ...
    ["радіо","кит","робот","ніж"],
    ["музей","людина","чашка","диван"], ["ванна", "сонце", "життя", "мити"],
    ["насолоджуватися", "ліки", "ніс", "зуби"], ["злий", "нещасний", "танці", "заздрісний"],
    ["дідусь", "товстий", "тітка", "сестра"], ["вода", "полуниця", "скло", "родина"],
    ["крокодил", "пам'ятати", "повітря", "кросівки"], ["стілець", "їжа", "ручка", "рука"],
    ["комаха", "велосипед", "близько", "потяг"],  ["велосипед", "червоний", "нога", "окуляри"],
    ["двір", "ручка", "кімната", "хор"], ["театр", "газета", "душа", "вії"],
    ["каблучка", "капелюх", "шкарпетки", "містечко"], ["хотіти", "любов", "мураха", "занавіска"],
    ["сад", "теніс", "шити", "історія"], ["дивитися", "спраглий", "ревнивий", "страшний"]];
...
export const sounds_g2_test_a1 = ['../Music/game2/A1/1.mp3','../Music/game2/A1/2.mp3','../Music/game2/A1/3.mp3','../Music/game2/A1/4.mp3','../Music/game2/A1/5.mp3',
    '../Music/game2/A1/6.mp3', '../Music/game2/A1/7.mp3','../Music/game2/A1/8.mp3','../Music/game2/A1/9.mp3','../Music/game2/A1/10.mp3','../Music/game2/A1/11.mp3','../Music/game2/A1/12.mp3',
    '../Music/game2/A1/13.mp3','../Music/game2/A1/14.mp3','../Music/game2/A1/15.mp3','../Music/game2/A1/16.mp3','../Music/game2/A1/17.mp3','../Music/game2/A1/18.mp3','../Music/game2/A1/19.mp3',
    '../Music/game2/A1/20.mp3'
]
...
export const words_g2_tests_a2 = ["килим", "стеля", "небезпека", "щасливий", "прикраси",
    "іграшка", "ноутбук", "білизна", "дядько", "вид", "пропонувати", "кофта",
    "намисто", "платформа", "медсестра", "вбивати", "хокей", "подарунок", "палець", "поганий"];
...
export const answers_g2_tests_a2 = [["килим","дивний","червоний","кіт"],
    ...
    ["іграшка", "небо", "брат", "посуд"],
    ["ноутбук", "кава", "дерево", "лампа"],
    ["ковтати", "працювати", "білизна", "бабуся"],
    ["їдальня", "дядько", "телефон", "камінь"],
    ["чорний", "дивитися", "вид", "дерево"],
    ["прикрашати", "пропонувати", "дивитися", "любити"],
    ["кофта", "ручка", "лікоть", "родимка"],
    ["білий", "штани", "намисто", "вікно"],
    ["платформа", "палець", "окуляри", "захищати"],
    ["марудний", "медсестра", "прозорий", "дитина"],
    ["душити", "вбивати", "говорити", "чекати"],
    ["ключ", "дім", "лід", "хокей"],
    ["подарунок", "мати", "прикраси", "занавіска"],
    ["ніготь", "палець", "вуха", "волосся"],
    ["поганий", "надійний", "горить", "дихати"]
...
export const sounds_g2_test_a2 = ['../Music/game2/A2/1.mp3','../Music/game2/A2/2.mp3','../Music/game2/A2/3.mp3','../Music/game2/A2/4.mp3','../Music/game2/A2/5.mp3',
    '../Music/game2/A2/6.mp3', '../Music/game2/A2/7.mp3','../Music/game2/A2/8.mp3','../Music/game2/A2/9.mp3','../Music/game2/A2/10.mp3','../Music/game2/A2/11.mp3','../Music/game2/A2/12.mp3',
    '../Music/game2/A2/13.mp3','../Music/game2/A2/14.mp3','../Music/game2/A2/15.mp3','../Music/game2/A2/16.mp3','../Music/game2/A2/17.mp3','../Music/game2/A2/18.mp3','../Music/game2/A2/19.mp3',
    '../Music/game2/A2/20.mp3'
]
...
export const words_g2_tests_b1 = ["діаграма", "теля", "освіта", "фінальний", "іміграція",
    "іміграція", "жарт", "джунглі", "леді", "метод",
    "олія", "власник", "простий", "тропіки", "моряк",
    "тихо","шок", "серветка", "молодий", "зона"
];
...
export const answers_g2_tests_b1 = [["діаграма","чорний","гранж","світло"],
    ...
    ["інгредієнт", "дошка", "крейда", "спати"],
    ["жарт", "зерно", "мед", "лак"],
    ["орбіта", "топити", "джунглі", "змія"],
    ["поні", "леді", "двері", "лілія"],
    ["марудний", "джинси", "метод", "вичерпати"],
    ["бурштин", "олія", "пісок", "камінь"],
    ["власник", "робити", "гриби", "ризина"],
    ["білий", "просити", "простий", "черевики"],
    ["тропіки", "ліс", "зелень", "кущ"],
    ["капітан", "моряк", "море", "вітрило"],
    ["говіркий", "тихо", "широко", "сповільнюватися"],
    ["кричати", "гарувати", "різати", "шок"],
    ["серветка", "лист", "проблема", "жувати"],
    ["дитина", "молодий", "павільйон", "шнурки"],
    ["зона", "орбіта", "надихати", "мрія"]
];
...
export const sounds_g2_test_b1 = ['../Music/game2/B1/1.mp3','../Music/game2/B1/2.mp3','../Music/game2/B1/3.mp3','../Music/game2/B1/4.mp3','../Music/game2/B1/5.mp3',
    '../Music/game2/B1/6.mp3', '../Music/game2/B1/7.mp3','../Music/game2/B1/8.mp3','../Music/game2/B1/9.mp3','../Music/game2/B1/10.mp3','../Music/game2/B1/11.mp3','../Music/game2/B1/12.mp3',
    '../Music/game2/B1/13.mp3','../Music/game2/B1/14.mp3','../Music/game2/B1/15.mp3','../Music/game2/B1/16.mp3','../Music/game2/B1/17.mp3','../Music/game2/B1/18.mp3','../Music/game2/B1/19.mp3',
    '../Music/game2/B1/20.mp3'
]


//b2
export const words_g2_tests_b2 = ["закинутий", "точний", "переваги", "жувати", "кохана",
    "нетерпляче","вогонь","молоток","гачок",
    "виправдати","удача", "затор", "коліно",
    "підкорятися", "сюжет", "смаглявий", "терміни",
    "несвідомий", "дійсний", "позіхати"];
...
export const answers_g2_tests_b2 = [["закинутий", "нажаханий", "товстий", "чарівний"],
    ...
    ["нетерпляче", "ринути", "поважати", "голодний"],
    ["вогонь", "сухий", "розрізати", "мандрувати"],
    ["різак", "дримба", "молоток", "барабани"],
    ["підказка", "гачок", "передзвін", "брутто"],
    ["прекрасний", "простий", "виправдати", "справедливий"],
    ["витівка", "удача", "гордість", "напис"],
    ["затор", "фікція", "побачення", "гомілка"],
    ["щиколотка", "литка", "коліно", "передпліччя"],
    ["підкорятися", "прислухатися", "навчати", "захищати"],
    ["історія", "сюжет", "плов", "сумка"],
    ["цілитися", "смаглявий", "срібний", "підсмажений"],
    ["скатертина", "розплановувати", "розраховувати", "терміни"],
    ["несвідомий", "чіткий", "визначений", "перебільшувати"],
    ["послідовний", "дійсний", "зазначений", "просрочений"],
    ["позіхати", "обіймати", "розчищати", "перемагати"]];
...
export const sounds_g2_test_b2 = ['../Music/game2/B2/1.mp3','../Music/game2/B2/2.mp3','../Music/game2/B2/3.mp3','../Music/game2/B2/4.mp3','../Music/game2/B2/5.mp3',
    '../Music/game2/B2/6.mp3', '../Music/game2/B2/7.mp3','../Music/game2/B2/8.mp3','../Music/game2/B2/9.mp3','../Music/game2/B2/10.mp3','../Music/game2/B2/11.mp3','../Music/game2/B2/12.mp3',
    '../Music/game2/B2/13.mp3','../Music/game2/B2/14.mp3','../Music/game2/B2/15.mp3','../Music/game2/B2/16.mp3','../Music/game2/B2/17.mp3','../Music/game2/B2/18.mp3','../Music/game2/B2/19.mp3',
    '../Music/game2/B2/20.mp3'
]

//c1
export const words_g2_tests_с1 = ["вживати", "здатність", "вирішальний", "найняти", "справедливість",
    "щедрий", "домагання", "наслідувати", "набалдашник", "сходи", "лагідний", "панно", "самовпевнений",
    "поширювати", "чистий", "мішок", "ціль", "непродуктивний", "перевірити", "шафа"];
...
export const answers_g2_tests_с1 = [["вживати","переважати","світити","писати"],
    ...
    ["щедрий", "закритий", "норовливий", "жовтий"],
    ["домагання", "перевівка", "аналітика", "ходити"],
    ["літати", "прослідковувати", "наслідувати", "споглядати"],
    ["гарувати", "набалдашник", "розвінчувати", "кліпати"],
    ["олівець", "лопата", "сходи", "наліпка"],
    ["задумувати", "лагідний", "гордливий", "кортіти"],
    ["панно", "розпрямляти", "тремпіти", "проголошувати"],
    ["спирт", "антисентик", "самовпевнений", "перескочити"],
    ["поширювати", "плавати", "перепрошувати", "нагатися"],
    ["наголошувати", "чистий", "цінувати", "розраховувати"],
    ["перерізати", "мішок", "шмат", "ніготь"],
    ["маржина", "лінія", "стріла", "ціль"],
    ["непродуктивний", "перелітний", "спрощений", "тривалий"],
    ["розподілити", "перевірити", "перемогти", "затиснути"],
    ["шафа", "тумба", "стіл", "корито"]];
...
export const sounds_g2_test_с1 = ['../Music/game2/C1/1.mp3','../Music/game2/C1/2.mp3','../Music/game2/C1/3.mp3','../Music/game2/C1/4.mp3','../Music/game2/C1/5.mp3',
    '../Music/game2/C1/6.mp3', '../Music/game2/C1/7.mp3','../Music/game2/C1/8.mp3','../Music/game2/C1/9.mp3','../Music/game2/C1/10.mp3','../Music/game2/C1/11.mp3','../Music/game2/C1/12.mp3',
    '../Music/game2/C1/13.mp3','../Music/game2/C1/14.mp3','../Music/game2/C1/15.mp3','../Music/game2/C1/16.mp3','../Music/game2/C1/17.mp3','../Music/game2/C1/18.mp3','../Music/game2/C1/19.mp3',
    '../Music/game2/C1/20.mp3'
]
...
export const words_g3_tests_a2 = ["chair","cherry","coconut","crab","doctor",
    "dress","flamingo","frog","key","kiwi",
    "lips","money","mouse","olive","queen",
    "sock","sunglasses","table","tomato","umbrella"]
export const images_g3_test_a2 = ["../Images/game3/A2/chair.png","../Images/game3/A2/cherry.png","../Images/game3/A2/coconut.png","../Images/game3/A2/crab.png","../Images/game3/A2/doctor.png",
    "../Images/game3/A2/dress.png","../Images/game3/A2/flamingo.png","../Images/game3/A2/frog.png","../Images/game3/A2/key.png","../Images/game3/A2/kiwi.png",
    "../Images/game3/A2/lips.png","../Images/game3/A2/money.png","../Images/game3/A2/mouse.png","../Images/game3/A2/olive.png","../Images/game3/A2/queen.png",
    "../Images/game3/A2/sock.png","../Images/game3/A2/sunglasses.png","../Images/game3/A2/table.png","../Images/game3/A2/tomato.png","../Images/game3/A2/umbrella.png"
]

//b1
export const words_g3_tests_b1 = ["baloon","beer","bread","coctail","cup",
    "donut","grape","honey","jam","knife",
    "lightbulb","lipstick","lollipop","palm","pillow",
    "plum","raspberry","rug","wallet","watermelon"]
export const images_g3_test_b1 = ["../Images/game3/B1/baloon.png","../Images/game3/B1/beer.png","../Images/game3/B1/bread.png","../Images/game3/B1/coctail.png","../Images/game3/B1/cup.png",
    "../Images/game3/B1/donut.png","../Images/game3/B1/grape.png","../Images/game3/B1/honey.png","../Images/game3/B1/jam.png","../Images/game3/B1/knife.png",
    "../Images/game3/B1/lightbulb.png","../Images/game3/B1/lipstick.png","../Images/game3/B1/lollipop.png","../Images/game3/B1/palm.png","../Images/game3/B1/pillow.png",
    "../Images/game3/B1/plum.png","../Images/game3/B1/raspberry.png","../Images/game3/B1/rug.png","../Images/game3/B1/wallet.png","../Images/game3/B1/watermelon.png"
]

//b2
export const words_g3_tests_b2 = ["bus","candy","cap","cookie","corn",
    "croissant","dinosaur","drums","fence","garlic",
    "ghost","hammer","meat","mushroom","pear",
    "potato","pumpkin","shop","shovel","violin"]
export const images_g3_test_b2 = ["../Images/game3/B2/bus.png","../Images/game3/B2/candy.png","../Images/game3/B2/cap.png","../Images/game3/B2/cookie.png","../Images/game3/B2/corn.png",
    "../Images/game3/B2/croissant.png","../Images/game3/B2/dinosaur.png","../Images/game3/B2/drums.png","../Images/game3/B2/fence.png","../Images/game3/B2/garlic.png",
    "../Images/game3/B2/ghost.png","../Images/game3/B2/hammer.png","../Images/game3/B2/meat.png","../Images/game3/B2/mushroom.png","../Images/game3/B2/pear.png",
    "../Images/game3/B2/potato.png","../Images/game3/B2/pumpkin.png","../Images/game3/B2/shop.png","../Images/game3/B2/shovel.png","../Images/game3/B2/violin.png"
]

//c1
export const words_g3_tests_c1 = ["ambulance","armchair","avocado","bee","butter",
    "butterfly","choir","cradle","hedgehog","helmet",
    "moustache","sheep","shorts","sink","stairs",
    "stapler","toiletries","tooth","trumpet","wipes"]
export const images_g3_test_c1 = ["../Images/game3/C1/ambulance.png","../Images/game3/C1/armchair.png","../Images/game3/C1/avocado.png","../Images/game3/C1/bee.png","../Images/game3/C1/butter.png",
    "../Images/game3/C1/butterfly.png","../Images/game3/C1/choir.png","../Images/game3/C1/cradle.png","../Images/game3/C1/hedgehog.png","../Images/game3/C1/helmet.png",
    "../Images/game3/C1/moustache.png","../Images/game3/C1/sheep.png","../Images/game3/C1/shorts.png","../Images/game3/C1/sink.png","../Images/game3/C1/stairs.png",
    "../Images/game3/C1/stapler.png","../Images/game3/C1/toiletries.png","../Images/game3/C1/tooth.png","../Images/game3/C1/trumpet.png","../Images/game3/C1/wipes.png"
]
...
export const words_g4_tests_a1 = ["hungry","kitchen","stirs","dishwashing","mountains",
    "brothers","hospital","kind","grandmother","living",
    "closet","dog","dolphins","ride","soup",
    "newspaper","costume","courses","college","sweets"
];
export const sentences_g4_tests_a1 = ["Jack was ----- .","She walked to the ----- .","Maria ----- the eggs.","Max washed the plate with ----- soap.","I live in a house near the -----.",
    "Lilia have two ----- and one sister.", "My mother is a nurse at a big -----.", "She is very -----.", "My sister likes to cook with my -----.", "They have a ----- room.",
    "They keep their clothes in the -----.", "John and Sarah like to play with the -----.", "Sometimes there are ----- and whales in the water!", "I do not ---- a bike.", "My mother cooks ----- for dinner.",
    "Dad put down his -----.", "Do you like my zombie -----?", "My favorite ----- are Geometry, French, and History.", "It is my second year in ----- now.", "Mom always brings me ----- and candy when they come."
]
export const sounds_g4_test_a1 = ["../Music/game4/A1/1.mp3","../Music/game4/A1/2.mp3","../Music/game4/A1/3.mp3","../Music/game4/A1/4.mp3","../Music/game4/A1/5.mp3",
    "../Music/game4/A1/6.mp3","../Music/game4/A1/7.mp3","../Music/game4/A1/8.mp3","../Music/game4/A1/9.mp3","../Music/game4/A1/10.mp3",
    "../Music/game4/A1/11.mp3","../Music/game4/A1/12.mp3","../Music/game4/A1/13.mp3","../Music/game4/A1/14.mp3","../Music/game4/A1/15.mp3",
    "../Music/game4/A1/16.mp3","../Music/game4/A1/17.mp3","../Music/game4/A1/18.mp3","../Music/game4/A1/19.mp3","../Music/game4/A1/20.mp3"
];


//a2
export const words_g4_tests_a2 = ["tourist","delicious","balcony","strawberries","illness",
    "socer","nurses","comprehend","turtles","headmaster",
    "backpack","grade","crayons","touch","conversations",
    "Perhaps","figure","grocery","cart","apartment"
];
export const sentences_g4_tests_a2 = ["We visited many famous ______ places.",
    ...
    "The doctors and ------ take care of them.",
    "I struggled to ----- their Spanish. ",
    "George likes the ----- best. ",
    "The talks to students. ",

    "His mother packs a big ---- full of book. ",
    "Kyle has trouble getting a good ---- in mathematics. ",
    "He draws on paper with ----- and pencils. ",
    "It is been a while since we have been in -----. ",
    "I understand most of our -----. ",

    "----- you could even come to visit!",
    "Is very hard for Lucas to ---- out.",
    "Martha is at the grocery store.",
    "She pushes her ---- ahead.",
    "I live in an -----.",
...
export const sounds_g4_test_a2 = ["../Music/game4/A2/1.mp3","../Music/game4/A2/2.mp3","../Music/game4/A2/3.mp3","../Music/game4/A2/4.mp3","../Music/game4/A2/5.mp3",
    "../Music/game4/A2/6.mp3","../Music/game4/A2/7.mp3","../Music/game4/A2/8.mp3","../Music/game4/A2/9.mp3","../Music/game4/A2/10.mp3",
    "../Music/game4/A2/11.mp3","../Music/game4/A2/12.mp3","../Music/game4/A2/13.mp3","../Music/game4/A2/14.mp3","../Music/game4/A2/15.mp3",
    "../Music/game4/A2/16.mp3","../Music/game4/A2/17.mp3","../Music/game4/A2/18.mp3","../Music/game4/A2/19.mp3","../Music/game4/A2/20.mp3"
];
...
export const words_g4_tests_b1 = ["spectacular","landmarks","exploring","underneath","enforcement",
    "assistance","professional","Firefighters","highway","federal",
    "sledding","characterized","considerable","rooted","purchase",
    "independence","copper","reservations","hiking","rush"
];
export const sentences_g4_tests_b1 = ["He take a tour of this ______ stadium.",
    ...
    "Doctors give health-related ---- to patients. ",
    "Chefs prepare meals in ----- settings. ",
    "------ serve the public by responding to fires. ",
    "I usually like driving on the -----. ",
    "Thanksgiving is a ----- holiday.",

    "Ice skating and ----- are commonly enjoyed winter activities. ",
    "Autumn is ----- by falling leaves. ",
    "Winter snowfall can be -----. ",
    "It is ----- in religion. ",
    "Customers can ----- fruits in a few different ways. ",

    "We celebrate 100 years of Americas -----. ",
    "The statues exterior is made of -----. ",
    "Claire made sure to make ----- before her visit. ",
    "The park contains ----- trails. ",
    "In the morning I am always in a -----."
...
export const sounds_g4_test_b1 = ["../Music/game4/B1/1.mp3","../Music/game4/B1/2.mp3","../Music/game4/B1/3.mp3","../Music/game4/B1/4.mp3","../Music/game4/B1/5.mp3",
    "../Music/game4/B1/6.mp3","../Music/game4/B1/7.mp3","../Music/game4/B1/8.mp3","../Music/game4/B1/9.mp3","../Music/game4/B1/10.mp3",
    "../Music/game4/B1/11.mp3","../Music/game4/B1/12.mp3","../Music/game4/B1/13.mp3","../Music/game4/B1/14.mp3","../Music/game4/B1/15.mp3",
    "../Music/game4/B1/16.mp3","../Music/game4/B1/17.mp3","../Music/game4/B1/18.mp3","../Music/game4/B1/19.mp3","../Music/game4/B1/20.mp3"
];
...
export const words_g4_tests_b2 = ["anxiety","significantly","attractions","breeding","meteorites",
    "identity","complex","abusive","accessed","vandalism",
    "physical","riot","increased","gatecrash","vaulting",
    "urban","athletic","superiors","explicit","research"
];
export const sentences_g4_tests_b2 = ["These people are more at risk from ______.",
    ...
    "Protect your ----- online. ",
    "Make them more ----- by using a combination of letters. ",
    "There are ways to report ----- content. ",
    "The information can be -----. ",
    "There are a lot of debates over whether graffiti is -----. ",

    "Games can help to develop ----- skills.",
    "The Facebook party became a -----. ",
    "The number of invitation was -----. ",
    "There was nothing to ------. ",
    "They involve -----, jumping and landing. ",

    "Traceurs use both rural and ----- areas. ",
    "He had great ------ ability. ",
    "Challenging ----- is acceptable. ",
    "Managers often make indirect requests rather than ----- instructions. ",
    "It is very clear that a lot of --- went into the film. "
]
export const sounds_g4_test_b2 = ["../Music/game4/B2/1.mp3","../Music/game4/B2/2.mp3","../Music/game4/B2/3.mp3","../Music/game4/B2/4.mp3","../Music/game4/B2/5.mp3",
    "../Music/game4/B2/6.mp3","../Music/game4/B2/7.mp3","../Music/game4/B2/8.mp3","../Music/game4/B2/9.mp3","../Music/game4/B2/10.mp3",
    "../Music/game4/B2/11.mp3","../Music/game4/B2/12.mp3","../Music/game4/B2/13.mp3","../Music/game4/B2/14.mp3","../Music/game4/B2/15.mp3",
    "../Music/game4/B2/16.mp3","../Music/game4/B2/17.mp3","../Music/game4/B2/18.mp3","../Music/game4/B2/19.mp3","../Music/game4/B2/20.mp3"
];
...
export const words_g4_tests_c1 = ["devalued","mutation","capability","subtle","desperation",
    "surplus","ascended","endure","conducted","inappropriate",
    "conscientious","simultaneous","sulfur","surface","pledge",
    "taxes","mortality","terrorism","stabilises","distributed"
];
export const sentences_g4_tests_c1 = ["The positives feedback can become ______ and ignored. ",
    ...
    "Charities are only accessing 2% of supermarkets food -----. ",
    "Mountain runner Kilian Burgada ----- the mountain in May 2017. ",
    "He can ----- difficult conditions. (endure)",
    "Much of todays business is ------ across international borders. ",
    "Eye contact across genders is considered -----. ",

    "Judy is an extremely ------ worker. ",
    "She is also facing ------ deadlines. ",
    "The rocks also contain -----. ",
    "NASA suspects the methane comes from the ------ of the planet. ",
    "I ---- to be a full-time representative for the communities. ",

    "Our team will create jobs by reducing ---- and red tape. ",
    "The biggest factor in child ------ is poverty. ",
    "----- has shot up in the last few years. ",
    "The global population ------. ",
    "Natural resources need to be ----- more fairly."
]
export const sounds_g4_test_c1 = ["../Music/game4/C1/1.mp3","../Music/game4/C1/2.mp3","../Music/game4/C1/3.mp3","../Music/game4/C1/4.mp3","../Music/game4/C1/5.mp3",
    "../Music/game4/C1/6.mp3","../Music/game4/C1/7.mp3","../Music/game4/C1/8.mp3","../Music/game4/C1/9.mp3","../Music/game4/C1/10.mp3",
    "../Music/game4/C1/11.mp3","../Music/game4/C1/12.mp3","../Music/game4/C1/13.mp3","../Music/game4/C1/14.mp3","../Music/game4/C1/15.mp3",
    "../Music/game4/C1/16.mp3","../Music/game4/C1/17.mp3","../Music/game4/C1/18.mp3","../Music/game4/C1/19.mp3","../Music/game4/C1/20.mp3"
];
